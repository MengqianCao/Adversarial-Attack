...
from tools.conduct import adversiral_train
...
def train_epochs(model, trainloader, testloader, criterion, optimizer, device, num_epochs, attack_func, model_path):
    train_losses = []
    train_accuracies = []
    test_losses = []
    test_accuracies = []
    ...
    for epoch in range(num_epochs):
        ...
        model, train_loss, train_accuracy = adversiral_train(model, trainloader, criterion, optimizer, device, attack_func)
...
if __name__ == '__main__':
    ...
    model, train_losses, train_accuracies, test_losses, test_accuracies = train_epochs(
          model, trainloader, testloader, criterion, optimizer, device, num_epochs, attack_func, model_path)
